...
<html>
    <head>
        <meta charset="UTF-8">
        <title>BOOT ANIME</title>
        <link href="bootanime.css" rel="stylesheet" type="text/css"/>
    </head>
    <body>
        ...
        <div class="container">
            ...
            <div class="box" data-boot_flip="esquerda">
        ...
        <div class="container">
            <div class="data">
                <p>data-boot_flip="topo"</p>
            </div>
            <div class="box" data-boot_flip="topo">
                <img src="lolita_jft.jpg" alt=""/>
            </div>
        </div>
        <hr>
        ...
        <div class="container">
            <div class="data">
                <p>data-boot_flip="baixo"</p>
            </div>
            <div class="box" data-boot_flip="baixo">
                <img src="lolita_jft.jpg" alt=""/>
            </div>
        </div>
        <hr>
        ...
        <div class="container">
            <div class="data">
                <p>data-boot_flip="direita"</p>
            </div>
            <div class="box" data-boot_flip="direita">
                <img src="lolita_jft.jpg" alt=""/>
            </div>
        </div>
        <hr>
